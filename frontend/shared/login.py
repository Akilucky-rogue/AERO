...
/* ── AERO DUAL-BRAND BADGE (login page) ── */
.lp-brand-sep {{ width:1px; height:52px; background:#DDE0E8; flex-shrink:0; }}
.lp-aero-badge {{ display:flex; flex-direction:column; align-items:flex-start; }}
.lp-aero-name {{ font-family:'DM Sans','Inter',sans-serif; font-weight:900; font-size:28px; color:#4D148C; letter-spacing:3px; line-height:1; }}
.lp-aero-sub {{ font-family:'Inter',sans-serif; font-size:8px; color:#999; text-transform:uppercase; letter-spacing:0.8px; font-weight:600; line-height:1.6; }}
